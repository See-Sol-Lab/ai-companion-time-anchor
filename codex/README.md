...
> 本目录（`codex/`）是 **Codex / GPT 本地版**。如果你用的是**本地 Claude Code**，请看 [`../claude-code/`](../claude-code/)；如果你用的是**网页 / 手机端 Claude（Home）或网页版 GPT**，请看 [`../web/`](../web/)。仓库根目录的 [README](../README.md) 有三类导航。
